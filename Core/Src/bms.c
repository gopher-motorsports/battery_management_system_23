...
void updateGopherCan()
{
	...
	{
		static const FLOAT_CAN_STRUCT *cellVoltageParams[NUM_BMBS_IN_ACCUMULATOR][NUM_BRICKS_PER_BMB] =
		{
		...
		static const FLOAT_CAN_STRUCT *cellTempParams[NUM_BMBS_IN_ACCUMULATOR][NUM_BRICKS_PER_BMB] =
		{
		...
		static const FLOAT_CAN_STRUCT *boardTempParams[NUM_BMBS_IN_ACCUMULATOR][NUM_BRICKS_PER_BMB] =
		{
		...
		static const FLOAT_CAN_STRUCT *cellVoltageStatsParams[NUM_BMBS_IN_ACCUMULATOR][4] =
		{
		...
		static const FLOAT_CAN_STRUCT *cellTempStatsParams[NUM_BMBS_IN_ACCUMULATOR][3] =
		{
		...
		static const FLOAT_CAN_STRUCT *boardTempStatsParams[NUM_BMBS_IN_ACCUMULATOR][3] =
		{
		...
		static const U8_CAN_STRUCT *balswenParams[NUM_BMBS_IN_ACCUMULATOR][NUM_BRICKS_PER_BMB] =
		{
